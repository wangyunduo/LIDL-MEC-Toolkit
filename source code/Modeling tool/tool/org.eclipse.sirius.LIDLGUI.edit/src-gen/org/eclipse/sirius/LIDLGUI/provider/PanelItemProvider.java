...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.LIDLGUI.Panel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PanelItemProvider extends ContainerItemProvider {
	/**
	...
	protected void addSizeXPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Panel_SizeX_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Panel_SizeX_feature", "_UI_Panel_type"),
						LIDLGUIPackage.Literals.PANEL__SIZE_X, true, false, false,
	...
	protected void addSizeYPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Panel_SizeY_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Panel_SizeY_feature", "_UI_Panel_type"),
						LIDLGUIPackage.Literals.PANEL__SIZE_Y, true, false, false,
						ItemPropertyDescriptor.REAL_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Panel_type")
