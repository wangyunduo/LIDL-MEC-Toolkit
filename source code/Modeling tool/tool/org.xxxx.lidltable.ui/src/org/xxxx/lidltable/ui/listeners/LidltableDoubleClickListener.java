package org.xxxx.lidltable.ui.listeners;
...
public class LidltableDoubleClickListener implements IDoubleClickListener{
	
private final DTableTreeViewer viewer;
	
	public LidltableDoubleClickListener(DTableTreeViewer viewer) {
		this.viewer = viewer;
	}
	...
	private void realDoubleClick(IStructuredSelection sel, DCellSpec selectedCell) {
		...
		LidlTableUtils.transaction((session) -> {
