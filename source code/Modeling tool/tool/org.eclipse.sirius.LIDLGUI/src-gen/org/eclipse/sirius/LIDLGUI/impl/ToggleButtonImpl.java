 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.LIDLGUI.impl.ToggleButtonImpl#getSizeX <em>Size X</em>}</li>
 *   <li>{@link org.eclipse.sirius.LIDLGUI.impl.ToggleButtonImpl#getSizeY <em>Size Y</em>}</li>
 *   <li>{@link org.eclipse.sirius.LIDLGUI.impl.ToggleButtonImpl#getLabelString <em>Label String</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ToggleButtonImpl extends ButtonImpl implements ToggleButton {
	...
	protected EClass eStaticClass() {
		return LIDLGUIPackage.Literals.TOGGLE_BUTTON;
	}
	...
	public void setSizeX(double newSizeX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LIDLGUIPackage.TOGGLE_BUTTON__SIZE_X, oldSizeX,
					sizeX));
	}
	...
	public void setSizeY(double newSizeY) {
		...
		sizeY = newSizeY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LIDLGUIPackage.TOGGLE_BUTTON__SIZE_Y, oldSizeY,
					sizeY));
	}
	...
	public void setLabelString(String newLabelString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LIDLGUIPackage.TOGGLE_BUTTON__LABEL_STRING,
