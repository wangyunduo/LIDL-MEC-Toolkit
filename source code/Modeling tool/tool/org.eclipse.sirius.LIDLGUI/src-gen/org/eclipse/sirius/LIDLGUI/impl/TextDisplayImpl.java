 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.LIDLGUI.impl.TextDisplayImpl#getText <em>Text</em>}</li>
 *   <li>{@link org.eclipse.sirius.LIDLGUI.impl.TextDisplayImpl#getLegend <em>Legend</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextDisplayImpl extends IndicatorImpl implements TextDisplay {
	/**
	...
	protected EClass eStaticClass() {
		return LIDLGUIPackage.Literals.TEXT_DISPLAY;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LIDLGUIPackage.TEXT_DISPLAY__TEXT, oldText, text));
	}
	...
	public void setLegend(String newLegend) {
		...
		legend = newLegend;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LIDLGUIPackage.TEXT_DISPLAY__LEGEND, oldLegend,
					legend));
	}
